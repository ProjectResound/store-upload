...
describe('<Search />', function() {
  ...
  it('renders the search form', () => {
    expect(TestUtils.findRenderedDOMComponentWithClass(this.component, 'search__form')).to.exist;
  });
  ...
  context('user tapping on search button', () => {
    ...
    it('calls resoundAPI if there is a query', () => {
      ...
      TestUtils.Simulate.submit(TestUtils.findRenderedDOMComponentWithClass(this.component, 'search__form'));
