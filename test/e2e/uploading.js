...
test("Uploading and deleting", async t => {
  await t
    ...
    .expect(Selector(".queued-item__file-title").exists)
    .ok()
    .click("a.edit__link")
    .click("img.trash__icon")
    .click("div.delete__yes")
    .expect(Selector(".queue__header").innerText)
    .eql("Files You're Uploading")
    .expect(Selector("input.search__query").exists)
    .ok();
});
