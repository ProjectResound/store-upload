    ...
    <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="copyButton" transform="translate(1.000000, 1.000000)">
        ...
        <g id="Group-5" transform="translate(8.000000, 7.000000)">
          <mask id="icon-copy__mask-2" fill="white">
            <use xlinkHref="#icon-copy__path-1" />
          </mask>
          <g id="Clip-4" />
          <polygon
            id="Fill-3"
            fill="#0FB3CC"
            mask="url(#icon-copy__mask-2)"
            points="-5 -4.17647 21 -4.17647 21 25.5882353 -5 25.5882353"
          />
        </g>
        <g id="Group-8" transform="translate(12.000000, 13.000000)">
          <mask id="icon-copy__mask-4" fill="white">
            <use xlinkHref="#icon-copy__path-3" />
          </mask>
          <g id="Clip-7" />
          <polygon
            id="Fill-6"
            fill="#0FB3CC"
            mask="url(#icon-copy__mask-4)"
        ...
        <g id="Group-11" transform="translate(12.000000, 15.000000)">
          <mask id="icon-copy__mask-6" fill="white">
            <use xlinkHref="#icon-copy__path-5" />
          </mask>
          <g id="Clip-10" />
          <polygon
            id="Fill-9"
            fill="#0FB3CC"
            mask="url(#icon-copy__mask-6)"
        ...
        <g id="Group-14" transform="translate(12.000000, 17.000000)">
          <mask id="icon-copy__mask-8" fill="white">
            <use xlinkHref="#icon-copy__path-7" />
          </mask>
          <g id="Clip-13" />
          <polygon
            id="Fill-12"
            fill="#0FB3CC"
            mask="url(#icon-copy__mask-8)"
        ...
        <g id="Group-17" transform="translate(12.000000, 19.000000)">
          <mask id="icon-copy__mask-10" fill="white">
            <use xlinkHref="#icon-copy__path-9" />
          </mask>
          <g id="Clip-16" />
          <polygon
            id="Fill-15"
            fill="#0FB3CC"
            mask="url(#icon-copy__mask-10)"
        ...
        <g id="Group-20" transform="translate(11.000000, 5.000000)">
          <mask id="icon-copy__mask-12" fill="white">
            <use xlinkHref="#icon-copy__path-11" />
          </mask>
          <g id="Clip-19" />
          <polygon
            id="Fill-18"
            fill="#0FB3CC"
            mask="url(#icon-copy__mask-12)"
